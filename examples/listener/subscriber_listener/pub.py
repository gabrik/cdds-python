...
class IncompPub():
    def __init__(self):
        ...
        self.writer = Writer(self.pub, self.topic, [BestEffort(), KeepLastHistory(10), Deadline(dds_secs(10))])
    ...
    def write(self):
        ...
        cnt = 1
        while True:
            newMsg = HelloWorldData_Msg(userID = cnt, message = "Message {0}".format(cnt))
